...
namespace LPM.Web.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(LPMContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,EmailAddress,PhoneNumber,Gender,DateOfBirth,RegistrationDate,Password")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
